...
app.layout = html.Div(style={'text-align': 'Center', 'backgroundColor':colors['background'], 'color': colors['text']}, children =
                      ...
                      [html.H1("Toronto Weather Analysis"),
                       ...
                       html.H6("[-> WARNING <-] MAY TAKE UP TO 1 SECOND TO UPDATE THE GRAPHS AFTER CHANGING THE PARAMETERS", style = {'color' : 'lightgreen', 'font-weight': 'bold', "text-decoration": "underline"}),
